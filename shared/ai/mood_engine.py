...
Analyzes user input and returns a mood classification.
Used by persona agents to alter tone, intent, or personality in response.

This engine uses simple keyword mapping for now, but is built to be replaced
by fine-tuned sentiment analysis or emotion classifiers later.
"""
