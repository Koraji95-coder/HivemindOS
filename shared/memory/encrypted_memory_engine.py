"""
encrypted_memory_engine.py 🔒
-----------------------------
Decorator/wrapper memory engine that transparently encrypts
and decrypts all values at rest using Fernet symmetric encryption.

Wrap any compatible memory engine (e.g. SQL, file) to add at-rest security.

Set FERNET_KEY in your environment for consistent encryption.
"""
