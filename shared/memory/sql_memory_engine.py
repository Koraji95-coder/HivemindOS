"""
sql_memory_engine.py 🗄️
------------------------
A SQL-backed memory engine for persistent user key-value storage.
Supports both SQLite (local/dev) and Postgres (for instant cloud scaling).
Values are stored as plain text or JSON.

Usage:
    Set MEMORY_DB_URL to a PostgreSQL URL for cloud, or leave blank for local SQLite.
"""
...
DATABASE_URL = os.environ.get("MEMORY_DB_URL", "sqlite:///data/hivemind_memory.db")
